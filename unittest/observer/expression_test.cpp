...
TEST(ArithmeticExpr, get_column)
{
  ...
  // column op constant value
  {
    ...
    FieldMeta      field_meta1("col1", AttrType::INTS, 0, int_len, true, 0, 0);
  ...
  // column op column
  {
    ...
    Column         column_result;
    FieldMeta      field_meta1("col1", AttrType::INTS, 0, int_len, true, 0, 0);
    FieldMeta      field_meta2("col2", AttrType::INTS, 0, int_len, true, 1, 0);
    Field          field1(nullptr, &field_meta1);
...
TEST(ComparisonExpr, comparison_expr_test)
{
  ...
  }
  {
    const int               int_len = sizeof(int);
    Value                   int_value(1);
    FieldMeta               field_meta("col1", AttrType::INTS, 0, int_len, true, 0, 0);
