...
RC MvccTrxKit::init()
{
  ...
  fields_ = vector<FieldMeta>{
      ...
      FieldMeta("__trx_xid_begin", AttrType::INTS, 0 /*attr_offset*/, 4 /*attr_len*/, false /*visible*/, -1/*field_id*/, 0/*nullable*/),
      FieldMeta("__trx_xid_end", AttrType::INTS, 0 /*attr_offset*/, 4 /*attr_len*/, false /*visible*/, -2/*field_id*/, 0/*nullable*/)};
